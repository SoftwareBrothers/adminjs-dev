...
`;var Rl=t=>{const{resource:r,record:o,actionName:l}=t,a=r.actions.find((e=>e.name===l)),n=new Zo,{translateLabel:i}=Pl();return _(e).createElement(x.Box,{flexGrow:1,className:x.cssClass("Breadcrumbs")},_(e).createElement(Ml,{to:n.dashboardUrl()},i("dashboard")),_(e).createElement(Ml,{to:r.href?r.href:"/",className:o?"is-active":""},r.name),a&&"list"!==a.name&&_(e).createElement(Ml,{to:"#"},a.label))};const Al=e=>{const{actions:t,params:r,handleClick:o}=e,l=t.map((e=>{const t=Yo(e,r);return{icon:e.icon,label:e.label,variant:e.variant,source:e,href:t||void 0,onClick:t?o:void 0,"data-testid":rl(e),buttons:[]}})),a=l.reduce(((e,t)=>{const r=t.source;if(r.parent){const o=e[r.parent]||l.find((e=>e.source.name===r.parent))||{label:r.parent};return o.buttons=o.buttons||[],o.buttons.push(t),{...e,[r.parent]:o}}return{...e,[t.source.name]:t}}),{});return Object.values(a)},Ol=_(c)((({rounded:t,...r})=>_(e).createElement(a.Link,r)))`${x.ButtonCSS}`,Nl=new Zo,Tl=t=>{const{resourceId:r,showInDrawer:o}=t,l=o?"ChevronRight":"ChevronLeft",{from:a}=i.useSelector((e=>e.router)),{pathname:n,search:c}=a,s=n?[n,c].join(""):Nl.resourceUrl({resourceId:r,search:window.location.search});return _(e).createElement(Ol,{size:"icon",to:s,rounded:!0,mr:"lg",type:"button"},_(e).createElement(x.Icon,{icon:l}))};var Hl=t=>{const{resource:r,toggleFilter:o,actionPerformed:l,record:a,action:n,tag:i,omitActions:c}=t,{translateButton:s}=Pl(),d=v.useHistory(),p=Ll(l);if(n.hideActionHeader)return null;const m=r.id,u={resourceId:m,recordId:null==a?void 0:a.id},h=(e,t)=>ol({action:t,params:u,actionResponseHandler:p,push:d.push})(e),b=Al({actions:a?a.recordActions.filter((e=>!n||n.name!==e.name)):r.resourceActions.filter((e=>"new"===e.name&&(!n||n.name!==e.name))),params:u,handleClick:h});o&&b.push({label:s("filter",r.id),onClick:o,icon:"SettingsAdjust"});const f=Al({actions:n.showResourceActions?r.resourceActions.filter((e=>!["list","new"].includes(e.name))):[],params:{resourceId:m},handleClick:h}),g=n?n.label:r.name,q=n&&"list"===n.name,k=r.resourceActions.find((e=>"list"===e.name)),y=!n.showInDrawer,w=n.showInDrawer?"":"lg",C=n.showInDrawer?"xl":"default",E=n.showInDrawer?x.H3:x.H2;return _(e).createElement(x.Box,{className:x.cssClass("ActionHeader")},n.showInDrawer?"":_(e).createElement(x.Box,{flex:!0,flexDirection:"row",px:["default",0]},_(e).createElement(Rl,{resource:r,actionName:n.name,record:a}),_(e).createElement(x.Box,{flexShrink:0},_(e).createElement(x.ButtonGroup,{size:"sm",rounded:!0,buttons:f}))),_(e).createElement(x.Box,{display:["block",y?"flex":"block"]},_(e).createElement(x.Box,{mt:w,flexGrow:1,px:["default",0]},_(e).createElement(E,{mb:"lg"},!q&&k?_(e).createElement(Tl,{resourceId:m,showInDrawer:n.showInDrawer}):"",g,i?_(e).createElement(x.Badge,{variant:"primary",ml:"default"},i):"")),c?"":_(e).createElement(x.Box,{mt:"xl",mb:C,flexShrink:0},_(e).createElement(x.ButtonGroup,{buttons:b}))))};const jl=({error:t})=>{const{translateMessage:r}=Pl();return _(e).createElement(x.MessageBox,{m:"xxl",variant:"danger",message:"Javascript Error"},_(e).createElement(x.Text,null,t.toString()),_(e).createElement(x.Text,{mt:"default"},r("seeConsoleForMore")))};class Gl extends _(e).Component{constructor(e){super(e),this.state={error:null}}componentDidCatch(e){this.setState({error:e})}render(){const{children:t}=this.props,{error:r}=this.state;return null!==r?_(e).createElement(jl,{error:r}):t||null}}var Ul=Gl,Wl={};$(Wl,"show",(()=>ta)),$(Wl,"edit",(()=>Ql)),$(Wl,"list",(()=>ea));var Vl=t=>{const{resource:r,property:o}=t,{translateProperty:l,translateButton:a}=Pl(),n=l(`${o.path}.addNewItem`,r.id,{defaultValue:a("addNewItem",r.id)});return _(e).createElement(_(e).Fragment,null,_(e).createElement(x.Icon,{icon:"Add"}),n)};const Zl=t=>{const{property:r}=t;return r.description?_(e).createElement(x.Box,{mx:"sm",display:"inline-flex"},_(e).createElement(x.Tooltip,{direction:"top",title:r.description,size:"lg"},_(e).createElement(x.Box,null,_(e).createElement(x.Icon,{icon:"Help",color:"info"})))):null},Jl=t=>{const{property:r,props:o}=t;return r.hideLabel?null:_(e).createElement(x.Label,{htmlFor:r.path,required:r.isRequired,...o},r.label,r.description&&_(e).createElement(Zl,{property:r}))},Yl=(e,t)=>({...e,path:[e.path,t].join("."),label:`[${t+1}]`,isArray:!1,isDraggable:!1}),Kl=t=>{const{ItemComponent:r,property:o,onDelete:l,index:a,record:n,isDraggable:i}=t,c=window.btoa(unescape(encodeURIComponent(`${JSON.stringify(fl(n.params,o.path))}-${o.path}`)));return _(e).createElement(w.Draggable,{draggableId:c,index:a,key:c,isDragDisabled:!i},(a=>_(e).createElement(x.Box,{ref:a.innerRef,...a.draggableProps,...a.dragHandleProps,backgroundColor:"white",flex:!0,flexDirection:"row",alignItems:"center","data-testid":o.path},_(e).createElement(x.Box,{flexGrow:1},_(e).createElement(r,t)),_(e).createElement(x.Box,{flexShrink:0,ml:"lg"},_(e).createElement(x.Button,{rounded:!0,ml:"default","data-testid":"delete-item",type:"button",size:"icon",onClick:e=>l(e,o),variant:"danger"},_(e).createElement(x.Icon,{icon:"TrashCan"}))))))},Xl=t=>{const{property:r,record:o,resource:l,onChange:a}=t,n=fl(o.params,r.path)||[],i=e.useCallback((e=>{const t=[...n,r.subProperties.length?{}:""];return a(r.path,t),e.preventDefault(),!1}),[o,a,r]),c=e.useCallback(((e,t)=>{const r=((e,t)=>{const r=Object.keys(e.populated).reduce(((e,t)=>({...e,[t]:t})),{}),o=ql(r,t),l=Object.entries(o).reduce(((t,[r,o])=>({...t,[r]:o&&e.populated[null==o?void 0:o.toString()]})),{});return{...e,params:ql(e.params,t),populated:l}})(o,t.path);return a(r),e.preventDefault(),!1}),[o,a,r]),s=e.useCallback((e=>{const{source:t,destination:o}=e;if(!t||!o||o.index===t.index)return;const l=Array.from(n),[i]=l.splice(t.index,1);l.splice(o.index,0,i),a(r.path,l)}),[o,a,r]);return _(e).createElement(w.DragDropContext,{onDragEnd:s},_(e).createElement(w.Droppable,{droppableId:r.path},(o=>_(e).createElement(x.Section,{ref:o.innerRef,...o.droppableProps,mt:"xl",className:r.path},n.map(((o,l)=>{const a=Yl(t.property,l);return _(e).createElement(Kl,{...t,property:a,isDraggable:r.isDraggable,key:a.path,onDelete:c,index:l})})),o.placeholder,_(e).createElement(x.Button,{onClick:i,type:"button",rounded:!0},_(e).createElement(Vl,{resource:l,property:r}))))))},Ql=t=>{const{property:r,record:o,testId:l}=t,a=o.errors&&o.errors[r.propertyPath];return _(e).createElement(x.FormGroup,{error:!!a,"data-testid":l},_(e).createElement(Jl,{property:r}),_(e).createElement(Xl,t),_(e).createElement(x.FormMessage,null,a&&a.message))};var ea=t=>{const{property:r,record:o}=t,l=fl(o.params,r.path)||[],{translateProperty:a}=Pl();return _(e).createElement("span",null,`${a("length")}: ${l.length}`)};class ta extends _(e).PureComponent{render(){const{property:t,record:r,ItemComponent:o}=this.props,l=fl(r.params,t.path)||[];return _(e).createElement(x.ValueGroup,{label:t.label},_(e).createElement(x.Section,null,(l||[]).map(((r,l)=>{const a=Yl(t,l);return _(e).createElement(o,{...this.props,key:a.path,property:a})}))))}}var ra={};function oa(e,t){const[r]=t.name.split(".").slice(-1);return{...t,path:[e.path,r].join(".")}}$(ra,"show",(()=>aa)),$(ra,"edit",(()=>la)),$(ra,"list",(()=>na));var la=t=>{const{property:r,record:o,ItemComponent:l}=t,a=o.errors&&o.errors[r.path];return _(e).createElement(x.FormGroup,{error:!!a},_(e).createElement(Jl,{property:r}),_(e).createElement(x.Section,r.props,r.subProperties.filter((e=>!e.isId)).map((o=>{const a=oa(r,o);return _(e).createElement(l,{...t,key:a.path,property:a})}))),_(e).createElement(x.FormMessage,null,a&&a.message))};var aa=t=>{const{property:r,ItemComponent:o}=t;return _(e).createElement(x.ValueGroup,{label:r.label},_(e).createElement(x.Section,null,r.subProperties.filter((e=>!e.isId)).map((l=>{const a=oa(r,l);return _(e).createElement(o,{...t,key:a.path,property:a})}))))};class na extends _(e).PureComponent{renderItems(){const{property:t,ItemComponent:r}=this.props;return _(e).createElement(_(e).Fragment,null,t.subProperties.filter((e=>!e.isId)).map((o=>{const l=oa(t,o);return _(e).createElement("div",{key:l.path},_(e).createElement(x.Label,{inline:!0},`${o.label}: `),_(e).createElement(r,{...this.props,property:l}))})))}render(){const{property:t,record:r,resource:o}=this.props,l=r.recordActions.find((e=>"show"===e.name));if(o.titleProperty.propertyPath===t.propertyPath&&l){const t=(new Zo).recordActionUrl({resourceId:o.id,recordId:r.id,actionName:"show"});return _(e).createElement(a.Link,{to:t},this.renderItems())}return this.renderItems()}}var ia={};$(ia,"show",(()=>sa)),$(ia,"edit",(()=>ha)),$(ia,"filter",(()=>fa)),$(ia,"list",(()=>ga));var ca=t=>{const{property:r,record:o}=t,l=null==o?void 0:o.params[r.path];if(void 0===l)return null;if(r.availableValues){const t=r.availableValues.find((e=>e.value===l));return t?_(e).createElement(x.Badge,null,(null==t?void 0:t.label)||l):l}return l};class sa extends _(e).PureComponent{render(){const{property:t}=this.props;return _(e).createElement(x.ValueGroup,{label:t.label},_(e).createElement(ca,this.props))}}const da=(e,t)=>{const r=e.record.params[e.property.path],o=t.record.params[t.property.path],l=e.record.errors[e.property.path],a=t.record.errors[t.property.path];return r===o&&l===a},pa=t=>{var r;const{property:o,record:l}=t,a=null===(r=l.errors)||void 0===r?void 0:r[o.path];return _(e).createElement(x.FormGroup,{error:Boolean(a)},_(e).createElement(Jl,{property:o}),o.availableValues?_(e).createElement(ma,t):_(e).createElement(ua,t),_(e).createElement(x.FormMessage,null,a&&a.message))},ma=t=>{var r;const{theme:o,record:l,property:a,onChange:n}=t;if(!a.availableValues)return null;var i;const c=null!==(i=null===(r=l.params)||void 0===r?void 0:r[a.path])&&void 0!==i?i:"",s=x.selectStyles(o),d=a.availableValues.find((e=>e.value===c));var p;return _(e).createElement(_(C),{isClearable:!0,styles:s,value:d,required:a.isRequired,options:a.availableValues,onChange:e=>n(a.path,null!==(p=null==e?void 0:e.value)&&void 0!==p?p:""),isDisabled:a.isDisabled,...a.props})},ua=t=>{var r;const{property:o,record:l,onChange:a}=t;var n;const i=null!==(n=null===(r=l.params)||void 0===r?void 0:r[o.path])&&void 0!==n?n:"",[c,s]=e.useState(i);return e.useEffect((()=>{c!==i&&s(i)}),[i]),_(e).createElement(x.Input,{id:o.path,name:o.path,required:o.isRequired,onChange:e=>s(e.target.value),onBlur:()=>a(o.path,c),onKeyDown:e=>13===e.keyCode&&a(o.path,c),value:c,disabled:o.isDisabled,...o.props})};var ha=c.withTheme(e.memo(pa,da));class ba extends _(e).PureComponent{constructor(e){super(e),this.handleInputChange=this.handleInputChange.bind(this),this.handleSelectChange=this.handleSelectChange.bind(this)}handleInputChange(e){const{onChange:t,property:r}=this.props;t(r.path,e.target.value)}handleSelectChange(e){const{onChange:t,property:r}=this.props,o=e?e.value:"";t(r.path,o)}renderInput(){const{property:t,filter:r,theme:o}=this.props,l=`filter-${t.path}`,a=r[t.path]||"";if(t.availableValues){const r=t.availableValues.find((e=>e.value===a));return _(e).createElement(_(C),{value:void 0===r?"":r,isClearable:!0,options:t.availableValues,styles:x.filterStyles(o),onChange:this.handleSelectChange})}return _(e).createElement(x.Input,{name:l,onChange:this.handleInputChange,value:a})}render(){const{property:t}=this.props;return _(e).createElement(x.FormGroup,{variant:"filter"},_(e).createElement(x.Label,null,t.label),this.renderInput())}}var fa=c.withTheme(ba);class ga extends _(e).PureComponent{render(){return _(e).createElement(ca,this.props)}}var qa={};$(qa,"edit",(()=>va)),$(qa,"show",(()=>wa)),$(qa,"list",(()=>Ca)),$(qa,"filter",(()=>_a));const ka=t=>{const{property:r,onChange:o,record:l}=t,a=(e=>!(!e||"false"===e))(l.params&&l.params[r.path]),n=l.errors&&l.errors[r.path];return _(e).createElement(x.FormGroup,{error:!!n},_(e).createElement(x.CheckBox,{id:r.path,name:r.path,onChange:()=>{r.isDisabled||o(r.path,!a)},checked:a,disabled:r.isDisabled,...r.props}),_(e).createElement(Jl,{property:r,props:{inline:!0}}),_(e).createElement(x.FormMessage,null,n&&n.message))};var va=e.memo(ka,da),ya=e=>void 0===e?"":e?"Yes":"No";var xa=t=>{const{record:r,property:o,resource:l}=t,{translateProperty:a}=Pl(),n=null==r?void 0:r.params[o.path];if(void 0===n||""===n)return null;const i=ya(n),c=a(`${o.path}.${n}`,l.id,{defaultValue:i});return _(e).createElement(x.Badge,{outline:!0,size:"sm"},c)};class wa extends _(e).PureComponent{render(){const{property:t}=this.props;return _(e).createElement(x.ValueGroup,{label:t.label},_(e).createElement(xa,this.props))}}class Ca extends _(e).PureComponent{render(){return _(e).createElement(xa,this.props)}}class Ea extends _(e).PureComponent{constructor(e){super(e),this.handleChange=this.handleChange.bind(this)}handleChange(e){const{onChange:t,property:r}=this.props,o=e?e.value:"";t(r.path,o)}render(){const{property:t,filter:r={},theme:o}=this.props,l=void 0===r[t.path]?"":r[t.path],a=[{value:!0,label:ya(!0)},{value:!1,label:ya(!1)}],n=a.find((e=>e.value===l));return _(e).createElement(x.FormGroup,null,_(e).createElement(x.Label,null,t.label),_(e).createElement(_(C),{value:void 0===n?"":n,isClearable:!0,options:a,styles:x.filterStyles(o),onChange:this.handleChange}))}}var _a=c.withTheme(Ea),$a={};$($a,"edit",(()=>Sa)),$($a,"show",(()=>Ba)),$($a,"list",(()=>Pa)),$($a,"filter",(()=>Oa));const La=t=>{const{property:r,onChange:o,record:l}=t,a=l.params&&l.params[r.path]||"",n=l.errors&&l.errors[r.path];return _(e).createElement(x.FormGroup,{error:!!n},_(e).createElement(Jl,{property:r}),_(e).createElement(x.DatePicker,{value:a,disabled:r.isDisabled,onChange:e=>o(r.path,e),propertyType:r.type,...r.props}),_(e).createElement(x.FormMessage,null,n&&n.message))};var Sa=e.memo(La,da),za=(e,t)=>{if(!e)return"";const r=new Date(e);return r?x.formatDateProperty(r,t):""};class Ba extends _(e).PureComponent{render(){const{property:t,record:r}=this.props,o=za(r.params[t.path],t.type);return _(e).createElement(x.ValueGroup,{label:t.label},o)}}class Pa extends _(e).PureComponent{render(){const{property:t,record:r}=this.props,o=za(r.params[t.path],t.type);return _(e).createElement("span",null,o)}}var Da,Ia={};Da=Ia,Object.defineProperty(Da,"__esModule",{value:!0,configurable:!0}),$(Ia,"PARAM_SEPARATOR",(()=>Fa)),$(Ia,"Filter",(()=>Ma)),$(Ia,"default",(()=>Ra));const Fa="~~";class Ma{static normalizeKeys(e){return q.unflatten(q.flatten(e),{delimiter:Fa})}constructor(e={},t){this.resource=t;const r=Ma.normalizeKeys(e);this.filters=Object.keys(r).reduce(((e,t)=>(e[t]={path:t,property:this.resource.property(t),value:r[t]},e)),{})}get(e){return this.filters[e]}async populate(){const e=Object.keys(this.filters);for(let r=0;r<e.length;r+=1){var t;const o=e[r],l=null===(t=this.resource.decorate().getPropertyByKey(o))||void 0===t?void 0:t.reference();l&&(this.filters[o].populated=await l.findOne(this.filters[o].value))}return this}reduce(e,t){return Object.values(this.filters).reduce(e,t||{})}isVisible(){return!!Object.keys(this.filters).length}}var Ra=Ma;const{PARAM_SEPARATOR:Aa}=Ia;var Oa=t=>{const{property:r,filter:o,onChange:l}=t,{translateProperty:a}=Pl(),n=`${r.path}${Aa}from`,i=`${r.path}${Aa}to`,c=o[n],s=o[i];return _(e).createElement(_(e).Fragment,null,_(e).createElement(x.FormGroup,{variant:"filter"},_(e).createElement(x.Label,null,r.label),_(e).createElement(x.Label,null,`- ${a("from")}: `),_(e).createElement(x.DatePicker,{value:c,onChange:e=>l(n,e),propertyType:r.type}),_(e).createElement(x.Label,{mt:"default"},`- ${a("to")}: `),_(e).createElement(x.DatePicker,{value:s,onChange:e=>l(i,e),propertyType:r.type})))},Na={};$(Na,"edit",(()=>Ha)),$(Na,"show",(()=>ja)),$(Na,"list",(()=>Ga));const Ta=t=>{var r;const{property:o,record:l,onChange:a}=t;var n;const i=null!==(n=null===(r=l.params)||void 0===r?void 0:r[o.path])&&void 0!==n?n:"",c=l.errors&&l.errors[o.path],{props:s}=o,{quill:d={},...p}=s||{};return d.theme=d.theme||"snow",d.modules={toolbar:x.DefaultQuillToolbarOptions,...d.modules||{}},_(e).createElement(x.FormGroup,{error:Boolean(c)},_(e).createElement(Jl,{property:o}),_(e).createElement(x.RichText,{...p,value:i,onChange:e=>a(o.path,e),quill:d}),_(e).createElement(x.FormMessage,null,null==c?void 0:c.message))};var Ha=e.memo(Ta,da);class ja extends _(e).PureComponent{constructor(t){super(t),this.contentRef=_(e).createRef()}componentDidMount(){const{property:e,record:t}=this.props,r=t.params[e.path];this.contentRef.current.innerHTML=r}render(){const{property:t}=this.props;return _(e).createElement(x.ValueGroup,{label:t.label},_(e).createElement(x.Box,{variant:"grey",border:"default"},_(e).createElement(x.Text,{ref:this.contentRef})))}}var Ga=t=>{const{property:r,record:o}=t,l=o.params[r.path]||"",a=l.substring(0,15)+(l.length>15?"...":"");return _(e).createElement("span",null,a)},Ua={};$(Ua,"edit",(()=>Wa)),$(Ua,"show",(()=>Ja)),$(Ua,"list",(()=>Ya)),$(Ua,"filter",(()=>Xa));var Wa=c.withTheme((t=>{const{onChange:r,property:o,record:l,theme:a}=t,{reference:n}=o;if(!n)throw new Error(`Cannot reference resource in property '${o.path}'`);const i=null==l?void 0:l.errors[o.path],c=null==l?void 0:l.params[o.path],[s,d]=e.useState(),[p,m]=e.useState(0);var u;const h=null!==(u=null==l?void 0:l.populated[o.path])&&void 0!==u?u:s,b=c&&h?{value:h.id,label:h.title}:{value:"",label:""},f=x.selectStyles(a);return e.useEffect((()=>{if(!h&&c){m((e=>e+1));(new Qo).recordAction({actionName:"show",resourceId:n,recordId:c}).then((({data:e})=>{d(e.record)})).finally((()=>{m((e=>e-1))}))}}),[h,c,n]),_(e).createElement(x.FormGroup,{error:Boolean(i)},_(e).createElement(Jl,{property:o}),_(e).createElement(_(E),{cacheOptions:!0,value:b,styles:f,defaultOptions:!0,loadOptions:async e=>{const t=new Qo;return(await t.searchRecords({resourceId:n,query:e})).map((e=>({value:e.id,label:e.title,record:e})))},onChange:e=>{e?r(o.path,e.value,e.record):r(o.path,null)},isClearable:!0,isDisabled:o.isDisabled,isLoading:p,...o.props}),_(e).createElement(x.FormMessage,null,null==i?void 0:i.message))}));const Va=_(c)(a.Link)`
  ${x.ButtonCSS};
  padding-left: ${({theme:e})=>e.space.xs};
  padding-right: ${({theme:e})=>e.space.xs};
`;var Za=t=>{const{property:r,record:o}=t,l=new Zo,a=o.params[r.path],n=o.populated[r.path],i=n&&n.title||a;if(!r.reference)throw new Error(`property: "${r.path}" does not have a reference`);if(n&&n.recordActions.find((e=>"show"===e.name))){const t=l.recordActionUrl({resourceId:r.reference,recordId:a,actionName:"show"});return _(e).createElement(Va,{variant:"text",to:t},i)}return _(e).createElement("span",null,i)};class Ja extends _(e).PureComponent{render(){const{property:t,record:r}=this.props;return _(e).createElement(x.ValueGroup,{label:t.label},_(e).createElement(Za,{property:t,record:r}))}}class Ya extends _(e).PureComponent{render(){const{property:t,record:r}=this.props;return _(e).createElement(Za,{property:t,record:r})}}class Ka extends _(e).PureComponent{constructor(e){super(e),this.api=new Qo,this.options=[],this.loadOptions=this.loadOptions.bind(this),this.handleChange=this.handleChange.bind(this)}handleChange(e){const{onChange:t,property:r}=this.props;t(r.path,e?e.value:"")}async loadOptions(e){const{property:t}=this.props,r=await this.api.searchRecords({resourceId:t.reference,query:e});return this.options=r.map((e=>({value:e.id,label:e.title}))),this.options}render(){const{property:t,filter:r,theme:o}=this.props,l=void 0===r[t.path]?"":r[t.path],a=(this.options||[]).find((e=>e.value===l));return _(e).createElement(x.FormGroup,null,_(e).createElement(x.Label,null,t.label),_(e).createElement(_(E),{value:void 0===a?"":a,isClearable:!0,cacheOptions:!0,styles:x.filterStyles(o),loadOptions:this.loadOptions,onChange:this.handleChange,defaultOptions:!0}))}}var Xa=c.withTheme(Ka),Qa={};$(Qa,"show",(()=>en)),$(Qa,"edit",(()=>rn));class en extends _(e).PureComponent{render(){const{property:t,record:r}=this.props,o=r.params[t.path]||"";return _(e).createElement(x.ValueGroup,{label:t.label},o.split(/(?:\r\n|\r|\n)/g).map(((t,r)=>_(e).createElement(_(e).Fragment,{key:r},t,_(e).createElement("br",null)))))}}const tn=t=>{var r,o;const{onChange:l,property:a,record:n}=t;var i;const c=null!==(i=null===(r=n.params)||void 0===r?void 0:r[a.path])&&void 0!==i?i:"",[s,d]=e.useState(c),p=null===(o=n.errors)||void 0===o?void 0:o[a.path];return e.useEffect((()=>{s!==c&&d(c)}),[c]),_(e).createElement(x.FormGroup,{error:Boolean(p)},_(e).createElement(Jl,{property:a}),_(e).createElement(x.Input,{as:"textarea",rows:(s.match(/\n/g)||[]).length+1,id:a.path,name:a.path,onChange:e=>d(e.target.value),onBlur:()=>l(a.path,s),value:s,disabled:a.isDisabled,...a.props}),_(e).createElement(x.FormMessage,null,p&&p.message))};var rn=e.memo(tn,da),on={};$(on,"edit",(()=>an));const ln=t=>{const{property:r,record:o,onChange:l}=t,a=o.params[r.path],[n,i]=e.useState(a),c=o.errors&&o.errors[r.path],[s,d]=e.useState(!1);return e.useEffect((()=>{n!==a&&i(a)}),[a]),_(e).createElement(x.FormGroup,{error:!!c},_(e).createElement(Jl,{property:r}),_(e).createElement(x.InputGroup,null,_(e).createElement(x.Input,{type:s?"input":"password",className:"input",id:r.path,name:r.path,onChange:e=>i(e.target.value),onBlur:()=>l(r.path,n),onKeyDown:e=>13===e.keyCode&&l(r.path,n),value:null!=n?n:"",disabled:r.isDisabled,...r.props}),_(e).createElement(x.Button,{variant:s?"primary":"text",type:"button",size:"icon",onClick:()=>d(!s)},_(e).createElement(x.Icon,{icon:"View"}))),_(e).createElement(x.FormMessage,null,c&&c.message))};var an=e.memo(ln,da);let nn={};try{nn=window}catch(e){if("window is not defined"!==e.message)throw e}const cn={textarea:Qa,boolean:qa,datetime:$a,reference:Ua,password:on,date:$a,richtext:Na,string:ia,number:ia,float:ia,mixed:null},sn=t=>{const{property:r,resource:o,record:l,filter:a,where:n,onChange:i}=t,c=e.useMemo((()=>({...r,path:r.path||r.propertyPath})),[r]),s=`property-${n}-${c.path}`;let d=cn[c.type]&&cn[c.type][n]||ia[n];if(c.components&&c.components[n]){const t=c.components[n];if(!t)throw new Error(`there is no "${c.path}.components.${n}"`);return d=nn.AdminJS.UserComponents[t],_(e).createElement(Ul,null,_(e).createElement(x.Box,{"data-testid":s},_(e).createElement(d,{property:c,resource:o,record:l,filter:a,onChange:i,where:n})))}const p=Wl[n],m=ra[n];return r.isArray?p?_(e).createElement(p,{...t,property:c,ItemComponent:sn,testId:s}):_(e).createElement("div",null):"mixed"===r.type?m?_(e).createElement(m,{...t,property:c,ItemComponent:sn,testId:s}):_(e).createElement("div",null):_(e).createElement(Ul,null,_(e).createElement(x.Box,{"data-testid":s},_(e).createElement(d,{property:c,resource:o,record:l,filter:a,onChange:i,where:n})))};function dn(e){return{Edit:e.edit,Show:e.show,List:e.list,Filter:e.filter}}const pn=Object.assign(sn,{DefaultType:dn(ia),Boolean:dn(qa),DateTime:dn($a),RichText:dn(Na),Reference:dn(Ua),TextArea:dn(Qa),Password:dn(on)}),mn=t=>{const{layoutElement:r,resource:o,where:l,record:a,onChange:n}=t,{props:i,properties:c,layoutElements:s,component:d}=r,{children:p,...m}=i,u=c.map((e=>o.properties[e])),h=x[d];return h?_(e).createElement(h,m,u.map((t=>_(e).createElement(x.Box,{flexGrow:1,key:t.propertyPath},_(e).createElement(pn,{key:t.propertyPath,where:l,property:t,resource:o,record:a,onChange:n})))),s.map(((r,o)=>_(e).createElement(mn,{...t,key:o,layoutElement:r}))),p):_(e).createElement(x.MessageBox,{size:"sm",message:"Javascript Error",variant:"danger",py:"xl"},"There is no component by the name of",_(e).createElement(x.Badge,{size:"sm",variant:"danger",mx:"default"},d),"in @adminjs/design-system. Change",_(e).createElement(x.Badge,{size:"sm",variant:"danger",mx:"default"},`@${d}`),"to available component like @Header")};var un=mn;const hn=t=>{const{resource:r,record:o,action:l}=t,a=r.showProperties;return _(e).createElement(x.DrawerContent,null,(null==l?void 0:l.showInDrawer)?_(e).createElement(Hl,t):null,l.layout?l.layout.map(((r,o)=>_(e).createElement(un,{key:o,layoutElement:r,...t,where:"show"}))):a.map((t=>_(e).createElement(pn,{key:t.propertyPath,where:"show",property:t,resource:r,record:o}))))},bn=e=>[e?"table-cell":"none",e?"table-cell":"none","table-cell","table-cell"];var fn=t=>{const{resource:r,record:o,actionPerformed:l,isLoading:n,onSelect:i,isSelected:c}=t,[s,d]=e.useState(o),p=a.useHistory(),m=e.useCallback((e=>{e.record&&!e.redirectUrl?d(cl(s,e)):l&&l(e)}),[l,s]),u=Ll(m);e.useEffect((()=>{d(o)}),[o]);const{recordActions:h}=s,b=s.recordActions.find((({name:e})=>"show"===e)),f=s.recordActions.find((({name:e})=>"edit"===e)),g=b||f,q={resourceId:r.id,recordId:s.id},k=[{icon:"OverflowMenuHorizontal",variant:"light",label:void 0,"data-testid":"actions-dropdown",buttons:Al({actions:h,params:q,handleClick:(e,t)=>ol({action:t,params:q,actionResponseHandler:u,push:p.push})(e)})}];return _(e).createElement(x.TableRow,{onClick:e=>{const t=e.target.tagName.toLowerCase();g&&"a"!==t&&"button"!==t&&"svg"!==t&&ol({action:g,params:{resourceId:r.id,recordId:s.id},actionResponseHandler:u,push:p.push})(e)},"data-id":s.id},_(e).createElement(x.TableCell,{className:c?"selected":"not-selected"},i&&s.bulkActions.length?_(e).createElement(x.CheckBox,{onChange:()=>i(s),checked:c}):null),r.listProperties.map((t=>_(e).createElement(x.TableCell,{style:{cursor:"pointer"},key:t.propertyPath,"data-property-name":t.propertyPath,display:bn(t.isTitle)},n?_(e).createElement(x.Placeholder,{style:{height:14}}):_(e).createElement(pn,{key:t.propertyPath,where:"list",property:t,resource:r,record:s})))),_(e).createElement(x.TableCell,{key:"options"},h.length?_(e).createElement(x.ButtonGroup,{buttons:k}):""))};class gn extends _(e).PureComponent{constructor(e){super(e),this.isActive=this.isActive.bind(this)}isActive(){const{sortBy:e,property:t}=this.props;return e===t.propertyPath}render(){const{property:t,location:r,direction:o}=this.props,l=new URLSearchParams(r.search),n=this.isActive()&&"asc"===o?"desc":"asc",i="Caret"+("asc"===o?"Up":"Down");return l.set("direction",n),l.set("sortBy",t.propertyPath),_(e).createElement(a.NavLink,{to:{search:l.toString()},className:x.cssClass("SortLink")},t.label,this.isActive()?_(e).createElement(x.Icon,{icon:i,color:"primary100",ml:"default"}):"")}}var qn=a.withRouter(gn);var kn=t=>{const{property:r,titleProperty:o,display:l}=t,a=r.propertyPath===o.propertyPath;return _(e).createElement(x.TableCell,{className:a?"main":void 0,display:l},r.isSortable?_(e).createElement(qn,t):r.label)};var vn=t=>{const{titleProperty:r,properties:o,sortBy:l,direction:a,onSelectAll:n,selectedAll:i}=t;return _(e).createElement(x.TableHead,null,_(e).createElement(x.TableRow,null,_(e).createElement(x.TableCell,null,n?_(e).createElement(x.CheckBox,{style:{marginLeft:5},onChange:()=>n(),checked:i}):null),o.map((t=>_(e).createElement(kn,{display:bn(t.isTitle),key:t.propertyPath,titleProperty:r,property:t,sortBy:l,direction:a}))),_(e).createElement(x.TableCell,{key:"actions",style:{width:80}})))};function yn(t,r){if("undefined"==typeof window)return t;return o=>{let l=window;l=window;let a=t;return l.AdminJS&&l.AdminJS.UserComponents&&l.AdminJS.UserComponents[r]?(a=l.AdminJS.UserComponents[r],_(e).createElement(a,{...o,OriginalComponent:t})):_(e).createElement(a,o)}}const xn=yn((t=>{const{resource:r}=t,{translateButton:o,translateMessage:l}=Pl(),a=r.resourceActions.find((e=>"new"===e.name));return _(e).createElement(x.InfoBox,{title:l("noRecords",r.id)},_(e).createElement(x.Text,{mb:"xxl"},l("noRecordsInResource",r.id)),a?_(e).createElement(Fl,{action:a,resourceId:r.id},_(e).createElement(x.Button,{variant:"primary"},_(e).createElement(x.Icon,{icon:"Add"}),o("createFirstRecord",r.id))):"")}),"NoRecords");var wn=xn;var Cn=e=>Object.values(e.reduce(((e,t)=>({...e,...t.bulkActions.reduce(((e,t)=>({...e,[t.name]:t})),{})})),{}));var En=t=>{const{resource:r,selectedRecords:o}=t,{translateLabel:l}=Pl(),a=v.useHistory(),n=Ll();if(!o||!o.length)return null;const i={resourceId:r.id,recordIds:o.map((e=>e.id))},c=Al({actions:Cn(o),params:i,handleClick:(e,t)=>ol({action:t,params:i,actionResponseHandler:n,push:a.push})(e)});return _(e).createElement(x.TableCaption,null,_(e).createElement(x.Box,{flex:!0,py:"sm",alignItems:"center"},_(e).createElement(x.Title,{mr:"lg"},l("selectedRecords",r.id,{selected:o.length})),_(e).createElement(x.ButtonGroup,{size:"sm",rounded:!0,buttons:c})))};var _n=t=>{const{resource:r,records:o,actionPerformed:l,sortBy:a,direction:n,isLoading:i,onSelect:c,selectedRecords:s,onSelectAll:d}=t;if(!o.length)return i?_(e).createElement(x.Loader,null):_(e).createElement(wn,{resource:r});const p=s&&!!o.find((e=>s.find((t=>t.id===e.id)))),m=!!o.find((e=>e.bulkActions.length));return _(e).createElement(x.Table,null,_(e).createElement(En,{resource:r,selectedRecords:s}),_(e).createElement(vn,{properties:r.listProperties,titleProperty:r.titleProperty,direction:n,sortBy:a,onSelectAll:m?d:void 0,selectedAll:p}),_(e).createElement(x.TableBody,null,o.map((t=>_(e).createElement(fn,{record:t,resource:r,key:t.id,actionPerformed:l,isLoading:i,onSelect:c,isSelected:s&&!!s.find((e=>e.id===t.id))})))))};const $n=e=>({addNotice:t=>e(al(t))}),Ln=e=>i.connect(null,$n)(e),Sn=Ln(v.withRouter((t=>{const{resource:r,records:o,action:l,addNotice:a,history:n}=t,[i,c]=e.useState(!1),{translateMessage:s,translateButton:d}=Pl();if(!o)return _(e).createElement(x.Text,null,s("pickSomeFirstToRemove",r.id));return _(e).createElement(_(e).Fragment,null,_(e).createElement(x.DrawerContent,null,(null==l?void 0:l.showInDrawer)?_(e).createElement(Hl,{omitActions:!0,...t}):null,_(e).createElement(x.MessageBox,{mb:"xxl",variant:"danger",message:s("theseRecordsWillBeRemoved",r.id,{count:o.length})}),_(e).createElement(x.Table,null,_(e).createElement(x.TableBody,null,o.map((t=>_(e).createElement(x.TableRow,{key:t.id},_(e).createElement(x.TableCell,null,_(e).createElement(pn,{where:"list",property:r.titleProperty,resource:r,record:t})))))))),_(e).createElement(x.DrawerFooter,null,_(e).createElement(x.Button,{variant:"primary",size:"lg",onClick:()=>{const e=new Qo;c(!0);const t=o.map((e=>e.id));e.bulkAction({resourceId:r.id,actionName:l.name,recordIds:t,method:"post"}).then((e=>{if(c(!1),e.data.notice&&a(e.data.notice),e.data.redirectUrl){const t=new URLSearchParams(window.location.search);t.delete("recordIds"),n.push(_l(e.data.redirectUrl,t.toString()))}})).catch((e=>{throw c(!1),a({message:s("bulkDeleteError",r.id),type:"error"}),e}))},disabled:i},i?_(e).createElement(x.Icon,{icon:"Fade",spin:!0}):null,d("confirmRemovalMany",r.id,{count:o.length}))))}))),zn={new:t=>{const{record:r,resource:o,action:l}=t,{record:a,handleChange:n,submit:i,loading:c,setRecord:s}=El(r,o.id),{translateButton:d}=Pl(),p=v.useHistory();e.useEffect((()=>{r&&s(r)}),[r]);return _(e).createElement(x.Box,{as:"form",onSubmit:e=>(e.preventDefault(),i().then((e=>{e.data.redirectUrl&&p.push(_l(e.data.redirectUrl)),e.data.record.id&&!Object.keys(e.data.record.errors).length&&n({params:{},populated:{},errors:{}})})),!1),flex:!0,flexGrow:1,flexDirection:"column"},_(e).createElement(x.DrawerContent,null,(null==l?void 0:l.showInDrawer)?_(e).createElement(Hl,t):null,l.layout?l.layout.map(((r,o)=>_(e).createElement(un,{key:o,layoutElement:r,...t,where:"edit",onChange:n,record:a}))):o.editProperties.map((t=>_(e).createElement(pn,{key:t.propertyPath,where:"edit",onChange:n,property:t,resource:o,record:a})))),_(e).createElement(x.DrawerFooter,null,_(e).createElement(x.Button,{variant:"primary",size:"lg",type:"submit","data-testid":"button-save",disabled:c},c?_(e).createElement(x.Icon,{icon:"Fade",spin:!0}):null,d("save",o.id))))},edit:t=>{const{record:r,resource:o,action:l}=t,{record:a,handleChange:n,submit:i,loading:c,setRecord:s}=El(r,o.id),{translateButton:d}=Pl(),p=v.useHistory();e.useEffect((()=>{r&&s(r)}),[r]);return _(e).createElement(x.Box,{as:"form",onSubmit:e=>(e.preventDefault(),i().then((e=>{e.data.redirectUrl&&p.push(_l(e.data.redirectUrl))})),!1),flex:!0,flexGrow:1,flexDirection:"column"},_(e).createElement(x.DrawerContent,null,(null==l?void 0:l.showInDrawer)?_(e).createElement(Hl,t):null,l.layout?l.layout.map(((r,o)=>_(e).createElement(un,{key:o,layoutElement:r,...t,where:"edit",onChange:n,record:a}))):o.editProperties.map((t=>_(e).createElement(pn,{key:t.propertyPath,where:"edit",onChange:n,property:t,resource:o,record:a})))),_(e).createElement(x.DrawerFooter,null,_(e).createElement(x.Button,{variant:"primary",size:"lg",type:"submit","data-testid":"button-save",disabled:c},c?_(e).createElement(x.Icon,{icon:"Fade",spin:!0}):null,d("save",o.id))))},show:hn,list:({resource:t,setTag:r})=>{const{records:o,loading:l,direction:a,sortBy:n,page:i,total:c,fetchData:s,perPage:d}=Il(t.id),{selectedRecords:p,handleSelect:m,handleSelectAll:u,setSelectedRecords:h}=function(t){const[r,o]=e.useState([]);return{handleSelect:e=>{const t=r.findIndex((t=>t.id===e.id));if(t<0)o([...r,e]);else{const e=[...r];e.splice(t,1),o(e)}},handleSelectAll:()=>{const e=t.filter((e=>!r.find((t=>t.id===e.id))&&e.bulkActions.length));if(e.length)o([...r,...e]);else{const e=r.filter((e=>!t.find((t=>t.id===e.id))));o(e)}},selectedRecords:r,setSelectedRecords:o}}(o),b=v.useLocation(),f=v.useHistory();e.useEffect((()=>{r&&r(c.toString())}),[c]),e.useEffect((()=>{h([])}),[t.id]),e.useEffect((()=>{new URLSearchParams(b.search).get("refresh")&&h([])}),[b.search]);return _(e).createElement(x.Box,{variant:"white"},_(e).createElement(_n,{resource:t,records:o,actionPerformed:()=>s(),onSelect:m,onSelectAll:u,selectedRecords:p,direction:a,sortBy:n,isLoading:l}),_(e).createElement(x.Text,{mt:"xl",textAlign:"center"},_(e).createElement(x.Pagination,{page:i,perPage:d,total:c,onChange:e=>{const t=new URLSearchParams(b.search);t.set("page",e.toString()),f.push({search:t.toString()})}})))},bulkDelete:Sn},Bn="https://docs.adminjs.co";"object"==typeof process&&process.env.ADMIN_JS_TMP_DIR;var Pn=t=>{const{resource:r,action:o,record:l,records:a,setTag:n}=t,i=[Bn,"BaseAction.html"].join("/"),{translateMessage:c}=Pl();let s=zn[o.name];return o.component&&(s=AdminJS.UserComponents[o.component]),s?_(e).createElement(Ul,null,_(e).createElement(s,{action:o,resource:r,record:l,records:a,setTag:n})):s||_(e).createElement(x.MessageBox,{variant:"danger"},c("noActionComponent"),_(e).createElement(y.Trans,{key:"messages.buttons.seeTheDocumentation"},"See:",_(e).createElement(x.Link,{ml:"default",href:i},"the documentation")))};var Dn=({children:r,width:o})=>{const[l,a]=e.useState(window.document.getElementById("drawerPortal"));if(!l&&window){const r=window.document.createElement("div"),o=_(e).createElement(c.ThemeProvider,{theme:window.THEME},_(e).createElement(x.Drawer,{id:"drawerPortal",className:"hidden"}));window.document.body.appendChild(r),t.render(o,r,(()=>{a(window.document.getElementById("drawerPortal"))}))}return e.useEffect((()=>l?(l.classList.remove("hidden"),o&&(l.style.width=Array.isArray(o)?o[0].toString():o.toString()),()=>{l.style.width=x.DEFAULT_DRAWER_WIDTH,l.classList.add("hidden")}):()=>{}),[l]),l?t.createPortal(r,l):null};var In=yn((({resources:t})=>{const r=Bl(t),{translateLabel:o}=Pl();return _(e).createElement(x.Navigation,{label:o("navigation"),elements:r})}),"SidebarResourceSection");window.reactComponents={},window.vueComponents={},window.React=_(e),window.ReactDOM=_(t),window.ReactWrapper=_(P),window._CustomWrapper=Go,reactComponents.ActionButton=Fl,reactComponents.ActionHeader=Hl,reactComponents.Badge=se,reactComponents.BaseActionComponent=Pn,reactComponents.BasePropertyComponent=sn,reactComponents.Box=kt,reactComponents.Breadcrumbs=Rl,reactComponents.Button=$e,reactComponents.ButtonGroup=t=>{const{buttons:r,size:o,rounded:l}=t;return r&&r.length?_(e).createElement(Fo,t,r.map(((t,r)=>_(e).createElement(Ao,{key:`${t.label||""}-${r}`,size:o,rounded:l,...t,className:Bo})))):null},reactComponents.CheckBox=Fe,reactComponents.CurrencyInput=mr,reactComponents.CurrentUserNav=t=>{const{name:r,title:o,avatarUrl:l,dropActions:a,lineActions:n}=t;return _(e).createElement(Ho,null,n&&n.length&&_(e).createElement(qt,{flex:!0,flexDirection:"row",alignItems:"center"},n.map((t=>_(e).createElement(_e,{size:"icon",variant:"text",title:t.label,key:t.label,href:t.href,as:"a",className:"line-action",onClick:t.onClick},t.icon&&_(e).createElement(Vt,{icon:t.icon}))))),_(e).createElement(Kr,{stick:"right",display:"flex"},_(e).createElement(no,null,_(e).createElement(qt,{flex:!0,flexDirection:"row",px:"xl",alignItems:"center",height:"navbarHeight"},_(e).createElement(qt,null,_(e).createElement(Gt,null,r),o&&_(e).createElement(jt,null,o)),l&&_(e).createElement("img",{src:l,alt:r}),a&&a.length&&_(e).createElement(Vt,{icon:"OverflowMenuVertical",size:16,ml:"md"}))),a&&a.length&&_(e).createElement(Qr,{minWidth:"100%"},a.map((t=>_(e).createElement(oo,{key:t.label,as:"a",onClick:t.onClick,href:t.href},t.icon&&_(e).createElement(Vt,{icon:t.icon}),t.label))))))},reactComponents.DatePicker=wr,reactComponents.Drawer=vo,reactComponents.DrawerContent=yo,reactComponents.DrawerFooter=go,reactComponents.DrawerPortal=Dn,reactComponents.DropDown=Xr,reactComponents.DropDownItem=lo,reactComponents.DropDownMenu=eo,reactComponents.DropDownTrigger=io,reactComponents.DropZone=Mr,reactComponents.DropZoneItem=Pr,reactComponents.ErrorMessageBox=t=>{const{children:r,title:o,testId:l}=t;return _(e).createElement(x.MessageBox,{"data-testid":l,message:o},_(e).createElement(x.Text,null,r))},reactComponents.FormGroup=gr,reactComponents.FormMessage=qr,reactComponents.Header=Tt,reactComponents.Icon=Zt,reactComponents.Illustration=ft,reactComponents.InfoBox=Ur,reactComponents.Input=Xe,reactComponents.InputGroup=ur,reactComponents.Label=ze,reactComponents.Link=Ve,reactComponents.Loader=Xt,reactComponents.LoggedUser=wo,reactComponents.MessageBox=Sr,reactComponents.Modal=t=>_(e).createElement(uo,t),reactComponents.ModalInline=po,reactComponents.NavGroup=Eo,reactComponents.Navigation=t=>{const{label:r,elements:o}=t;return _(e).createElement(Oo,{px:"xl",py:"lg"},_(e).createElement(Se,{pl:"lg",mb:"md",uppercase:!0},r),_(e).createElement("ul",null,o.map(((t,r)=>_(e).createElement(No,{key:[r,t.href].join("-"),...t})))))},reactComponents.NavigationElement=Zr,reactComponents.Pagination=fo,reactComponents.Placeholder=er,reactComponents.Radio=Oe,reactComponents.RecordsTable=_n,reactComponents.RecordsTableHeader=vn,reactComponents.RichText=jr,reactComponents.Section=Yt,reactComponents.ShowAction=Sn,reactComponents.ShowAction=hn,reactComponents.SidebarResourceSection=In,reactComponents.Step=Lo,reactComponents.Stepper=zo,reactComponents.Table=wt,reactComponents.TableBody=$t,reactComponents.TableCaption=Dt,reactComponents.TableCell=St,reactComponents.TableHead=Et,reactComponents.TableRow=Bt,reactComponents.Text=je,reactComponents.TextArea=et,reactComponents.Tooltip=t=>{const{direction:r,title:o,children:l,size:a}=t,n=e.useRef(null),[i,c]=e.useState(!1);let s,d;const p=_(e).Children.count(l);1===p?s=l:2===p&&_(e).Children.forEach(l,(e=>{var t;"TooltipContent"===(null===(t=e.type)||void 0===t?void 0:t.displayName)?d=e:s=e}));const m=e.forwardRef(((t,r)=>_(e).cloneElement(s,{...t,displayName:"TooltipTrigger",ref:r})));return _(e).createElement(_(e).Fragment,null,_(e).createElement(m,{ref:n,onMouseEnter:()=>{c(!0)},onMouseLeave:()=>{c(!1)}}),i&&_(e).createElement(cr,{title:o,childRef:n,size:a,direction:r,ContentElement:d}))},reactComponents.TooltipControl=ir,reactComponents.TooltipContent=dr,reactComponents.ValueGroup=t=>{const{label:r,value:o,children:l}=t;return _(e).createElement(qt,{mb:"xl"},_(e).createElement(Se,{variant:"light"},r),o?_(e).createElement(He,null,o):"",l)},reactComponents.withNotice=Ln;
